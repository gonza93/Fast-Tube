...
/**
 * Created by Gonzalo on 28/2/2016.
 */
public class RelatedAdapter extends RecyclerView.Adapter<RelatedAdapter.SimpleViewHolder>
    ...
    public RelatedAdapter(Context context, List<Video> items) {
    ...
    public void onItemClick(View view, final int position) {
        ...
        //Se le resta 1 siempre a la posicion, ya que el header layout (VideoInfoHeaderAdapter) ocupa una posicion dentro
        //del array adapter
        ...
        MainActivity.videoId = items.get(position - 1).getId();*/
